...
List symbolic_regression_cpp(NumericMatrix X, NumericVector y, int population_size, int generations, int tournament_size, CharacterVector unary_ops, CharacterVector binary_ops, int max_depth, int max_nodes, double target_loss, bool simplify, double crossover_probability, double seed, int n_populations, double timeout_seconds, int verbosity, double optimize_probability);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(symbolic_regression_cpp(X, y, population_size, generations, tournament_size, unary_ops, binary_ops, max_depth, max_nodes, target_loss, simplify, crossover_probability, seed, n_populations, timeout_seconds, verbosity, optimize_probability));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_rsymbolic2_symbolic_regression_cpp", (DL_FUNC) &_rsymbolic2_symbolic_regression_cpp, 17},
    {NULL, NULL, 0}
};
